...
namespace _Library.Arithmetic.Math
{
    ...
    ///	Thanks to http://www.lundin.info
    ///	
    /// </summary>
    /// <remarks>
    ///
    ///	Example usage:
    /// 
    ///	using _Library.Arithmetic.Math;
    ///	using System;
    ///	using System.Collections;
    ///
    ///	public class Test 
    ...
    ///
    /// 			double result = EP.Evaluate( "(3+2)*5");
    ///
    ...
    public class ExpressionParser
    {
        ...
        Evaluate(String exp)
        {
            ExpressionParser mRet = new ExpressionParser();
            return mRet.Parse(exp, null);
        }

        //public static double Evaluate1(string Expression)
        //{
        //    Arithmetic.Math.ExpressionParser mRet = new Arithmetic.Math.ExpressionParser();
        //    return mRet.Parse(Expression, null);
        //} 
        /// <summary>
...
} // End namespace _Library.Arithmetic.Math